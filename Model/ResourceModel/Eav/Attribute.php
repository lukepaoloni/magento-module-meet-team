...
namespace Kinspeed\MeetTeam\Model\ResourceModel\Eav;

use Kinspeed\MeetTeam\Setup\TeamSetup;
...
class Attribute extends EavAttribute implements ScopedAttributeInterface
{
     ...
     * Constants
     */
    const MODULE_NAME = 'Kinspeed_Team';
     ...
     * @var string
     */
    protected $_eventPrefix = TeamSetup::ENTITY_TYPE_CODE . '_entity_attribute';
    ...
    {
        $this->_init('Kinspeed\MeetTeam\Model\ResourceModel\Attribute');
    }
